...
[x] Find & Watch dendritic video
[x] find & watch den.lib video - didn't find any
[x] asking gemini for explanations
[x] reading through documentation for den
[] reading through documentation for dendritic
[] roaming through other people's configs
[] messing with new den config and testings with microVM




## Hosts/boxes/machines I want to eventually have
...
## Users that I think I will eventually need

- likivik
desc: desktop, laptop, spectacle user, admin access
